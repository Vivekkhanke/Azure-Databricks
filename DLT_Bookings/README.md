...
This folder defines all source code for the 'DLT_Bookings' pipeline:
...
* Take a look at the sample under "sample_users_dlt_bookings.py" to get familiar with the syntax.
